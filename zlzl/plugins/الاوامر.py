...
@zedub.tgbot.on(events.InlineQuery)
@check_owner
async def inline_zsource(event):
    builder = event.builder
    result = None
    query = event.text
...
async def zed_zsource_cmd(event):
...
@check_owner
async def inline_alsource(event):
    builder = event.builder
    result = None
    query = event.text
