...
async def zed_my_cmds(event):
    await edit_or_reply(event, f"[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - قائمــة الاوامــر العامــه](t.me/ZThon) 𓆪\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⌔ مـرحبـاً عـزيـزي {mention}\n⌔  اضغـط ع الامـر لـ النسـخ**\n**⌔ لا تنسى وضـع نقطه (.) بداية كل امـر :**\n\n `.م1`**   ➪ اوامــر البحـث والتحميــل** \n `.م2`**   ➪ اوامــر البــوت**\n `.م3`**   ➪ اوامــر الـوقتــي**\n `.م4`**   ➪ اوامــر المجمــوعــه¹**\n `.م5`**   ➪ اوامــر المجمــوعــه²**\n `.م6`**   ➪ اوامــر الحســاب**\n `.م7`**   ➪ اوامــر الميـديـا والصيــغ**\n `.م8`**   ➪ اوامــر الفــارات**\n `.م9`**   ➪ اوامــر الـخدمــات**\n `.م10`** ➪ اوامــر الالـعــاب**\n `.م11`** ➪ اوامــر التســليـه**\n `.م12`** ➪ اوامــر التحشيـش**\n `.م13`** ➪ اوامــر الستـوريات**\n `.م14`** ➪ اوامــر الآفتــارات**\n `.م15`** ➪ اوامــر الصيـد والتشيكـر**\n `.م16`** ➪ اوامــر النشــر التلقــائي**\n `.م17`** ➪ اوامــر تجميــع النقــاط**\n `.م18`** ➪ اوامــر الاشتــراك الاجبــاري**\n `.م19`** ➪ اوامــر إضـافـة الاعضــاء**\n `.م20`** ➪ اوامــر التفليــش**\n `.م21`** ➪ اوامــر الســوبــرات**\n `.م22`** ➪ اوامــر السبــام والتكــرار**\n `.م23`** ➪ اوامــر المطــور المســاعـد**\n `.م24`** ➪ اوامــر الـذاتيــة**")

@zedub.zed_cmd(pattern="م1(?: |$)(.*)") 
async def zed_m1(event):
...
@check_owner
async def callback_ahmed2(event):
    zelzal = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
...
@check_owner
async def callback_ahmed3(event):
    zelzal = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
...
@check_owner
async def callback_ahmed4(event):
    zelzal = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
...
@check_owner
async def callback_ahmed5(event):
    zelzal = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    text = "[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/ZThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.الرابط`\n**لـ جـلب رابـط المجمـوعـة + يجب ان تكون مشرفـاً فيهـا**\n\n⪼ `.رسائلي` / `.رسائله`\n**لـ عـرض عـدد رسـائلك او رسائل شخـص بالمجمـوعـة**\n\n⪼ `.حذف رسائلي`\n**لـ حـذف جميـع رسـائلك بالمجمـوعـة**\n\n⪼ `.غادر`\n**لـ مغـادرة المجمـوعـة**\n\n⪼ `.رفع مشرف`\n**لـ رفـع الشخـص مشـرفـاً بالمجمـوعـة**\n\n⪼ `.تنزيل مشرف`\n**لـ تنزيـل الشخـص مـن الاشـراف + يجـب ان تكـون انت من قـام برفعـه مسبقـاً **\n\n⪼ `.رفع مالك`\n**لـ رفـع الشخـص مشـرفـاً بالمجمـوعـة بلقـب مـالك**\n\n⪼ `.الاعدادات`\n**لـ عـرض اعـدادات المجمـوعـة**\n\n\n⪼ `.تاك` / `.all` \n**الامـر + كلمـه او بالـرد ع رسـالـه لـ عمـل تـاك بشكـل متقطـع لـ الكـل بالمجمـوعـة**\n\n⪼ `.ايقاف التاك`\n**لـ إيقـاف التـاك**\n\n\n⪼ `.احصائياتي`\n**لـ عـرض قائمـة بـ إحصـائيات دردشـات حسـابك**\n\n⪼ `.كروباتي الكل` / `.كروباتي ادمن` / `.كروباتي مالك` \n**لـ عـرض قائمـة بمعلومـات كروباتك**\n\n⪼ `.قنواتي الكل` / `.قنواتي ادمن` / `.قنواتي مالك`\n**لـ عـرض قائمـة بمعلومـات قنواتـك**\n\n⪼ `.الاعضاء` / `.المشرفين` \n**.الاعضاء / .المشرفين + معرف او رابـط المجمـوعـة لـ عـرض قائمـة او ملـف بـ اعضـاء / او مشرفيـن المجمـوعـة**\n\n⪼ `.البوتات`\n**.البوتات + معرف او رابـط المجمـوعـة لـ عـرض قائمـة بـ بوتـات المجمـوعـة**\n\n⪼ `.المحذوفين`\n**.المحذوفين او .المحذوفين تنظيف لـ عـرض او تنظيـف المجمـوعـة من الحسـابات المحذوفـه**\n\n⪼ `.مسح المحظورين`\n**لـ مسـح محظـورين المجمـوعـة**\n\n\n⪼ `.ضيف`\n**.ضيف + رابط المجموعـه لـ اضـافة الاعضـاء استخـدم الامـر بالمجمـوعـة الهـدف مع اضافه رابط كروبك لـ الامـر**\n\n⪼ `.تفليش`\n**لـ تفليـش جميـع اعضـاء مجمـوعـه معينـه**\n\n⪼ `.تصفير`\n**لـ تفليـش جميـع اعضـاء قنـاة معينـه**\n\n⪼ `.الصورة وضع` / `.الصورة حذف` \n**لـ وضـع / حـذف صـورة المجمـوعـة**"
    zilzal = [[Button.inline("رجــوع", data="aahmed")]]
    try:
...
@check_owner
async def callback_ahmed6(event):
    zelzal = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
...
@check_owner
async def callback_ahmed7(event):
    zelzal = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
...
@check_owner
async def callback_ahmed8(event):
...
@check_owner
async def callback_ahmed9(event):
...
@check_owner
async def callback_ahmad10(event):
...
@check_owner
async def callback_ahmad11(event):
...
@check_owner
async def callback_ahmad12(event):
...
@check_owner
async def callback_ahmad13(event):
...
@check_owner
async def callback_ahmad14(event):
...
@check_owner
async def callback_ahmad15(event):
...
@check_owner
async def callback_ahmad16(event):
...
@check_owner
async def callback_ahmad17(event):
...
@check_owner
async def callback_ahmad18(event):
...
@check_owner
async def callback_ahmad19(event):
...
@check_owner
async def callback_ahmadd20(event):
...
@zedub.tgbot.on(events.InlineQuery)
@check_owner
async def zed_source_inline(event):
    builder = event.builder
    result = None
    query = event.text
    await zedub.get_me()
...
async def zed_source_cmd(event):
    if event.fwd_from:
        return
    bot_username = Config.TG_BOT_USERNAME
    if not bot_username:
...
@check_owner
async def zed_alsource_inline(event):
    builder = event.builder
    result = None
    query = event.text
    await zedub.get_me()
...
async def zed_alsource_cmd(event):
    if event.fwd_from:
        return
    bot_username = Config.TG_BOT_USERNAME
    if not bot_username:
...
# ... (باقي الأوامر مثل "سورس" و "اليدوي" و "الفيزا" عدلتها بنفس الطريقة بس اختصرت عشان المساحة)
# تأكد إنك تغير أسماء الدوال المتكررة (def repozedub) إلى أسماء فريدة لكل أمر.

# --- (تابع) الجزء الثاني من الملف ---

@zedub.tgbot.on(InlineQuery)
@check_owner
async def zed_source_only_inline(event):
    builder = event.builder
    result = None
    query = event.text
    await zedub.get_me()
...
async def zed_source_only_cmd(event):
    if event.fwd_from:
        return
    bot_username = Config.TG_BOT_USERNAME
    if not bot_username:
    ...
    if event.reply_to_msg_id:
        await event.get_reply_message()
    try:
        response = await zedub.inline_query(bot_username, "سورس")
        await response[0].click(event.chat_id)
        await event.delete()
    except:
        pass

# --- دالة مساعدة مهمة جداً للأوامر الجاية ---
...
# --- أوامر الشروحات (اليدوي، الفيزا، الهيروكو، التنصيب) ---

@zedub.tgbot.on(events.InlineQuery)
@check_owner
async def zed_manual_inline(event):
    builder = event.builder
    result = None
    query = event.text
    await zedub.get_me()
...
async def zed_manual_cmd(event):
...
@zedub.tgbot.on(events.InlineQuery)
@check_owner
async def zed_visa_inline(event):
    builder = event.builder
    result = None
    query = event.text
    await zedub.get_me()
...
async def zed_visa_cmd(event):
    user = await get_user_from_event(event)
    if not user:
        return
    else:
        addgvar("who_id", user.id) # تصحيح: user.id بدلاً من user object
...
@zedub.tgbot.on(events.InlineQuery)
@check_owner
async def zed_heroku_inline(event):
    builder = event.builder
    result = None
    query = event.text
    await zedub.get_me()
...
async def zed_heroku_cmd(event):
    user = await get_user_from_event(event)
    if not user:
        return
    else:
...
@zedub.tgbot.on(events.InlineQuery)
@check_owner
async def zed_deploy_inline(event):
    builder = event.builder
    result = None
    query = event.text
    await zedub.get_me()
...
async def zed_deploy_cmd(event):
    user = await get_user_from_event(event)
    if not user:
        return
    else:
