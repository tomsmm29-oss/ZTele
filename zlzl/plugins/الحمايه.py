...
# --- الصق هذا في نهاية الملف تماماً ---
...
async def pmpermit_inline_handler(event):
    ...
    # النص الفخم (بيجيبه من المتغيرات عشان ما نلعبش في الفخامة)
    # لو مفيش نص محفوظ، بيحط النص الافتراضي الفخم بتاعك
    start_msg = gvarstatus("pmpermit_text")
    if not start_msg:
        start_msg = f"""ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗧𝗛𝗢𝗡 **- الـرد التلقـائي 〽️**
**•─────────────────•**
...
**⤶ اختر خيار واحد فقط لنعرف سبب قدومك الـى هنـا 🧐**"""
    ...
    # الأزرار (نفس اللي في الكود بتاعك)
    buttons = [
