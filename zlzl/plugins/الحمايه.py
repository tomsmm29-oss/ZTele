...
# ====================================================================
# ☢️ هذا هو القلب النابض للأزرار (لصق في نهاية الملف) ☢️
# ====================================================================
...
async def pmpermit_inline_handler(event):
    ...
    # النص الثابت (Hardcoded) عشان نضمن إنه يظهر وما يعتمدش على داتا بيز ممكن تكون فاضية
...
**⤶ اختر خيار واحد فقط لنعرف سبب قدومك الـى هنـا 🧐**"""
    ...
    # محاولة جلب النص المخصص لو موجود
    try:
        custom = gvarstatus("pmpermit_text")
        if custom:
            pm_text = custom
    except: pass
